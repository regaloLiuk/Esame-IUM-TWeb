...
--
-- Host: 127.0.0.1:3306
-- Creato il: Gen 07, 2020 alle 14:34
...
CREATE TABLE IF NOT EXISTS `insegnamento` (
  ...
  `professore` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `materia` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ripetizione` (
  ...
  `materia` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `i` int(1) NOT NULL,
  `giorno` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `ora` int(2) NOT NULL,
...
(1, 'Mario Rossi', 'Storia', 3, 'giovedi', 15, 0),
(1, 'Mario Rossi', 'Storia', 3, 'giovedi', 16, 0),
(1, 'Mario Rossi', 'Storia', 3, 'giovedi', 17, 0),
(1, 'Mario Rossi', 'Storia', 3, 'giovedi', 18, 0),
(1, 'Mario Rossi', 'Storia', 3, 'giovedi', 19, 0),
(1, 'Mario Rossi', 'Storia', 0, 'lunedi', 15, 1),
(1, 'Mario Rossi', 'Storia', 0, 'lunedi', 16, 1),
...
(1, 'Mario Rossi', 'Storia', 2, 'mercoledi', 17, 1),
...
(2, 'Anna Bianchi', 'Italiano', 0, 'lunedi', 15, 0),
(2, 'Anna Bianchi', 'Italiano', 0, 'lunedi', 16, 0),
...
(3, 'Marco Neri', 'Programmazione', 3, 'giovedi', 18, 0),
...
(3, 'Marco Neri', 'Programmazione', 1, 'martedi', 17, 0),
...
(4, 'Paolino Paperino', 'Matematica', 3, 'giovedi', 15, 0),
(4, 'Paolino Paperino', 'Matematica', 3, 'giovedi', 16, 0),
(4, 'Paolino Paperino', 'Matematica', 3, 'giovedi', 17, 0),
(4, 'Paolino Paperino', 'Matematica', 3, 'giovedi', 18, 0),
(4, 'Paolino Paperino', 'Matematica', 3, 'giovedi', 19, 0),
...
(4, 'Paolino Paperino', 'Matematica', 1, 'martedi', 15, 0),
...
(4, 'Paolino Paperino', 'Matematica', 2, 'mercoledi', 15, 1),
(4, 'Paolino Paperino', 'Matematica', 2, 'mercoledi', 16, 1),
...
('GinoPasticcino56', 3, 'Marco Neri ', 'Programmazione', 'lunedi', 15, 1),
('PinoAlbero34', 1, 'Mario Rossi', 'Italiano', 'lunedi', 15, 1),
('PinoAlbero34', 1, 'Mario Rossi', 'Italiano', 'lunedi', 16, 1),
('PinoAlbero34', 1, 'Mario Rossi', 'Storia', 'mercoledi', 17, 0),
('PinoAlbero34', 4, 'Paolino Paperino', 'Matematica', 'mercoledi', 15, 0);
